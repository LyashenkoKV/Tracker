...
enum Tracker: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
            case id, name, color, emoji, schedule, categoryTitle
            case type
        }
        ...
        func encode(to encoder: Encoder) throws {
            ...
            switch self {
            case .tracker(let id, let name, let color, let emoji, let schedule, let categoryTitle):
        ...
        init(from decoder: Decoder) throws {
            ...
            case .tracker:
                ...
                self = .tracker(id: id, name: name, color: color ?? UIColor(), emoji: emoji, schedule: schedule, categoryTitle: categoryTitle)
            }
        }
    }
